{
    version: 1,
    homepage: "http://www.goo-inside.me/supersonic/",
    ...
    // ROMs
    {
        ...
        summary: "Rooted, zipaligned, with busybox, from teshxx",
        device: "supersonic",
        ...
        url: "http://goo-inside.me/supersonic/stock/3.70.651.1-rooted-deodexed-signed-teshxx.zip"
    },
    {
        ...
        url: "http://goo-inside.me/supersonic/stock/3.70.651.1-rooted-odexed-signed-teshxx.zip"
    },
    {
        name: "Stock 3.30.651.3 Deodexed",
        summary: "Rooted, zipaligned, with busybox, from xxbabiboi228xx",
        device: "supersonic",
        product: "SupersonicStock",
    ...
    // Combos
    {
        ...
        summary: "Needs S-OFF! Updates the Radio/WiMAX/PRI+NV",
        device: "supersonic",
    ...
    // WiMAX
    {
        ...
        summary: "Requires S-OFF, from Calkulin",
        device: "supersonic",
    ...
    // HBOOT
    {
        ...
        summary: "Recommended, supports Fastboot, from Calkulin",
        device: "supersonic",
